...
import com.saraya.wecareproject.email.EmailSender;
import com.saraya.wecareproject.email.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = "http://localhost:8080/coach/register/confirm?token=" + token;
